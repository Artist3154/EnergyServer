package com.example.demo.commom.constant.result;
...
public enum ResultStatus {
    ...
    useremail_not_exist(1005, "用户名或者邮箱不正确"),
    pwd_not_same(1006,"两次密码输入不一致"),
    req_url_wrong(1007,"请求的链接不正确,请重新操作"),
    url_is_expire(1008,"链接已经过期"),
    user_not_exist(1009,"用户信息不存在"),
    digitalSignature_wrong(1010,"链接加密密码不正确");
