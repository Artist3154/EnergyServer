...
import com.example.demo.dao.entity.bo.DeviceStatusPost;
...
import com.example.demo.web.util.AliyunMessageTransformUtils;
...
public class DeviceMessageRegister implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception{
        //endPoint:http://$uid.iot-as-http2.$$regionid.aliyuncs.com
        String endPoint = "https://" + uid + ".iot-as-http2." + regionId + ".aliyuncs.com";
        //连接配置
        Profile profile = Profile.getAccessKeyProfile(endPoint, "cn-shanghai", "LTAIyh1aepAMWsap", "mrBO2WHVwkceX6PzmiRkefWXwtGDRF");

        //构造客户端
        MessageClient client = MessageClientFactory.messageClient(profile);
        client.setMessageListener(new MessageCallback() {
            @Override
            public MessageCallback.Action consume(MessageToken messageToken) {
                return null;
            }
        });
