...
import com.example.demo.service.constant.DeviceStatusCode;
...
public class DeviceInfoServiceImpl implements DeviceInfoService {
   ...
   public boolean updateStatus(String deviceName, String status) {
    ...
    public DeviceInfo getDeviceInfoByDeviceName(String deviceName) {
       ...
       public Set<String> listDeviceNames() {
           ...
           Set<String> deviceNames = deviceInfos.stream().map(DeviceInfo::getName).collect(Collectors.toSet());
           return deviceNames;
    }
  ...
  /*  @Override
    public Boolean updateOrInsertDeviceProperty(DevicePropertyPost devicePropertyPost) {
        DeviceInfo deviceInfo=new DeviceInfo();
        deviceInfo.setName(devicePropertyPost.getDeviceName());
        ...
        if (devicePropertyPost.getItems() != null) {
            ...
            int i = deviceInfoMapper.insertOrUpdateDeviceProperty(deviceInfo);
            if(i>0){
                return true;
            }
        }
