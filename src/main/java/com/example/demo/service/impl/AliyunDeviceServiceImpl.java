...
public class AliyunDeviceServiceImpl implements AliyunDeviceService{
   ...
   /* @Override
    public  Boolean rrpc(String deviceName, String identifier, String msg) throws ClientException {
        RRpcRequest request = new RRpcRequest();
        request.setProductKey(productKey);
        request.setDeviceName(deviceName);
        request.setRequestBase64Byte(Base64.encodeBase64String("hello world"));
